### `majoritylca` {#refcmd-majoritylca}
...
Dependency entry: [Open in map](#depcmd-majoritylca); functional module: [`taxonomy`](#mod-taxonomy).

**Usage**

`usage: mmseqs majoritylca <DB> [args] [options]`

The syntax line above is source-derived from command layer/category metadata. Run `mmseqs majoritylca` locally for exact positional arguments in your build.
