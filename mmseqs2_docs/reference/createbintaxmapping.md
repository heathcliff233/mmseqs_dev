...
Dependency entry: [Open in map](#depcmd-createbintaxmapping); functional module: [`taxonomy`](#mod-taxonomy).

**Usage**

`usage: mmseqs createbintaxmapping <DB> [args] [options]`

The syntax line above is source-derived from command layer/category metadata. Run `mmseqs createbintaxmapping` locally for exact positional arguments in your build.
