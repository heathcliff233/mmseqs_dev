...
| Detailed dependency entry | [Open in map](#depcmd-aggregatetaxweights) |
...
See [Dependency map section](#sec-dependency-map), [dependency entry](#depcmd-aggregatetaxweights), [command reference index](#sec-command-reference), and [functional module page](#mod-taxonomy).
