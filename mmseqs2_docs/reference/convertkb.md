...
Dependency entry: [Open in map](#depcmd-convertkb); functional module: [`utilities`](#mod-utilities).

**Usage**

`usage: mmseqs convertkb <DB> [args] [options]`

The syntax line above is source-derived from command layer/category metadata. Run `mmseqs convertkb` locally for exact positional arguments in your build.
