### `profile2pssm` {#refcmd-profile2pssm}
...
Dependency entry: [Open in map](#depcmd-profile2pssm); functional module: [`profiles`](#mod-profiles).

**Usage**

`usage: mmseqs profile2pssm <DB> [args] [options]`

The syntax line above is source-derived from command layer/category metadata. Run `mmseqs profile2pssm` locally for exact positional arguments in your build.
