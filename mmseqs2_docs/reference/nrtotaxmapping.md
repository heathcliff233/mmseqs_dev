### `nrtotaxmapping` {#refcmd-nrtotaxmapping}
...
Dependency entry: [Open in map](#depcmd-nrtotaxmapping); functional module: [`taxonomy`](#mod-taxonomy).

**Usage**

`usage: mmseqs nrtotaxmapping <DB> [args] [options]`

The syntax line above is source-derived from command layer/category metadata. Run `mmseqs nrtotaxmapping` locally for exact positional arguments in your build.
