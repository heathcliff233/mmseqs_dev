### `profile2consensus` {#refcmd-profile2consensus}
...
Dependency entry: [Open in map](#depcmd-profile2consensus); functional module: [`profiles`](#mod-profiles).

**Usage**

`usage: mmseqs profile2consensus <DB> [args] [options]`

The syntax line above is source-derived from command layer/category metadata. Run `mmseqs profile2consensus` locally for exact positional arguments in your build.
