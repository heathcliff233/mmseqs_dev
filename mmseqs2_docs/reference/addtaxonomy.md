...
| Detailed dependency entry | [Open in map](#depcmd-addtaxonomy) |
...
See [Dependency map section](#sec-dependency-map), [dependency entry](#depcmd-addtaxonomy), [command reference index](#sec-command-reference), and [functional module page](#mod-taxonomy).
