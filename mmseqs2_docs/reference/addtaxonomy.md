### `addtaxonomy` {#refcmd-addtaxonomy}
...
Dependency entry: [Open in map](#depcmd-addtaxonomy); functional module: [`taxonomy`](#mod-taxonomy).

**Usage**

`usage: mmseqs addtaxonomy <DB> [args] [options]`

The syntax line above is source-derived from command layer/category metadata. Run `mmseqs addtaxonomy` locally for exact positional arguments in your build.
