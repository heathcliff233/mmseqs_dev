...
| Aspect | Value |
| :--- | :--- |
| Called by modules | [`databases`](#refcmd-databases), [`pickconsensusrep`](#refcmd-pickconsensusrep) |
| Calls modules | `n/a` |
| Seen in workflow scripts | `databases.sh`, `pickconsensusrep.sh` |
...
See [Dependency map section](#sec-dependency-map), [dependency entry](#depcmd-msa2profile), [command reference index](#sec-command-reference), and [functional module page](#mod-profiles).
