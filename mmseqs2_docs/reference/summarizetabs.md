## `summarizetabs` {#refcmd-summarizetabs}
...
| Detailed dependency entry | [Open in map](#depcmd-summarizetabs) |
...
See [Dependency map section](#sec-dependency-map), [dependency entry](#depcmd-summarizetabs), [command reference index](#sec-command-reference), and [functional module page](#mod-utilities).
