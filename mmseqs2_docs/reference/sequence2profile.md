### `sequence2profile` {#refcmd-sequence2profile}
...
Dependency entry: [Open in map](#depcmd-sequence2profile); functional module: [`profiles`](#mod-profiles).

**Usage**

`usage: mmseqs sequence2profile <DB> [args] [options]`

The syntax line above is source-derived from command layer/category metadata. Run `mmseqs sequence2profile` locally for exact positional arguments in your build.
