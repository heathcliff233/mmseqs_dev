### `profile2neff` {#refcmd-profile2neff}
...
Dependency entry: [Open in map](#depcmd-profile2neff); functional module: [`profiles`](#mod-profiles).

**Usage**

`usage: mmseqs profile2neff <DB> [args] [options]`

The syntax line above is source-derived from command layer/category metadata. Run `mmseqs profile2neff` locally for exact positional arguments in your build.
