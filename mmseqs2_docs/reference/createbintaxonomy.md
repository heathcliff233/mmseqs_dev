### `createbintaxonomy` {#refcmd-createbintaxonomy}
...
Dependency entry: [Open in map](#depcmd-createbintaxonomy); functional module: [`taxonomy`](#mod-taxonomy).

**Usage**

`usage: mmseqs createbintaxonomy <DB> [args] [options]`

The syntax line above is source-derived from command layer/category metadata. Run `mmseqs createbintaxonomy` locally for exact positional arguments in your build.
