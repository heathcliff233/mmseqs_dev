...
| Detailed dependency entry | [Open in map](#depcmd-createbintaxonomy) |
...
See [Dependency map section](#sec-dependency-map), [dependency entry](#depcmd-createbintaxonomy), [command reference index](#sec-command-reference), and [functional module page](#mod-taxonomy).
