### `convertprofiledb` {#refcmd-convertprofiledb}
...
Dependency entry: [Open in map](#depcmd-convertprofiledb); functional module: [`profiles`](#mod-profiles).

**Usage**

`usage: mmseqs convertprofiledb <DB> [args] [options]`

The syntax line above is source-derived from command layer/category metadata. Run `mmseqs convertprofiledb` locally for exact positional arguments in your build.
