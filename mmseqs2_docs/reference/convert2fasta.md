### `convert2fasta` {#refcmd-convert2fasta}
...
Dependency entry: [Open in map](#depcmd-convert2fasta); functional module: [`result_handling`](#mod-result-handling).

**Usage**

`usage: mmseqs convert2fasta <DB> [args] [options]`

The syntax line above is source-derived from command layer/category metadata. Run `mmseqs convert2fasta` locally for exact positional arguments in your build.
